    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('width', models.CharField(blank=True, help_text='--пусто--', max_length=9, verbose_name='--пусто--')),
                ('longitude', models.CharField(blank=True, help_text='--пусто--', max_length=9, verbose_name='--пусто--')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account', models.CharField(help_text='Номер объекта', max_length=8, verbose_name='Номер объекта')),

# Generated by Django 2.2.9 on 2023-01-18 09:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_key', models.CharField(blank=True, help_text='Ключ объекта', max_length=20, unique=True, verbose_name='Ключ объекта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account', models.CharField(help_text='Передаваемый номер', max_length=8, verbose_name='Передаваемый номер')),
                ('note', models.CharField(blank=True, help_text='Примечание', max_length=200, verbose_name='Примечание')),
                ('none', models.CharField(blank=True, help_text='--пусто--', max_length=1, verbose_name='--пусто--')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transmission', models.CharField(choices=[('andromeda', 'Си-Норд'), ('ritm', 'Ритм'), ('navigard', 'Навигард'), ('eldes', 'Eldes'), ('jablotron', 'Jablotron'), ('dx', 'DX'), ('other', 'Прочее оборудование')], max_length=20, verbose_name='СПИ')),
                ('device', models.CharField(help_text='Прибор', max_length=30, unique=True, verbose_name='Прибор')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('part_sim', models.CharField(blank=True, choices=[('sim 1', 'sim 1'), ('sim 2', 'sim 2'), ('зам.', 'зам.'), ('блок', 'блок')], max_length=5, verbose_name='sim #')),
                ...
                ('device', models.ForeignKey(help_text='ППК', on_delete=django.db.models.deletion.CASCADE, related_name='sim', to='object_card.Device', verbose_name='ППК')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.PositiveIntegerField(help_text='№', verbose_name='№')),
                ('note', models.CharField(blank=True, max_length=50, verbose_name='Примечание')),
                ('application', models.CharField(blank=True, choices=[('MyAlarm', 'MyAlarm'), ('GeoRitm', 'GeoRitm'), ('PhoenixMK', 'PhoenixMK')], max_length=9, verbose_name='Приложение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.TextField(null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('device', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='object_card.Type_device', verbose_name='Тип ППК')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('status', models.CharField(choices=[('новый', 'Новый'), ('пультовой номер', 'Пультовой номер'), ('договор', 'Договор'), ('реагирование', 'Реагирование'), ('монтаж', 'Монтаж'), ('изменён', 'Изменён'), ('завершен', 'Завершен')], default='Новый', max_length=15, verbose_name='Статус заявки')),
                ('object_key', models.CharField(blank=True, db_index=True, help_text='Ключ объекта', max_length=20, verbose_name='Ключ объекта')),
                ('object_name', models.CharField(help_text='Название объекта', max_length=400, null=True, verbose_name='Название объекта')),
                ('phone', models.CharField(blank=True, help_text='Телефон на объекте', max_length=50, verbose_name='Телефон на объекте')),
                ('address', models.CharField(blank=True, help_text='Адрес', max_length=400, verbose_name='Адрес')),
                ('transmission', models.CharField(choices=[('andromeda', 'Си-Норд'), ('ritm', 'Ритм'), ('navigard', 'Навигард'), ('eldes', 'Eldes'), ('jablotron', 'Jablotron'), ('dx', 'DX'), ('other', 'Прочее оборудование')], max_length=20, verbose_name='СПИ')),
        ...
        migrations.AddField(
            model_name='device',
            name='device',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='type', to='object_card.Type_device', verbose_name='Тип ППК'),
        ),
        migrations.AddField(
            model_name='device',
            name='enginer_pult',

...
urlpatterns = [
    ...
    path('add_card_individual/<int:pk>/', views.CreateCardIndividual.as_view(), name='add_card_individual'),
    path('upd_card_individual/<int:pk>/', views.UpdateCardIndividual.as_view(), name='upd_card_individual'),
    path('add_card_legal/<int:pk>/', views.CreateCardLegal.as_view(), name='add_card_legal'),
    path('upd_card_legal/<int:pk>/', views.UpdateCardLegal.as_view(), name='upd_card_legal'),
